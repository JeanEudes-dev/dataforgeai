          ...
          <tbody className="divide-y divide-subtle">
            {columns.map((row, index) => (
              <motion.tr
                ...
                onClick={() =>
                  setExpandedColumn(
                    expandedColumn === row.column ? null : row.column
                  )
                }
                className={cn(
      ...
      <AnimatePresence>
        {expandedColumn && data?.[expandedColumn] && (
          <motion.div
            ...
            className="overflow-hidden border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50"
          >
            <div className="p-4 grid grid-cols-4 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="font-mono font-medium text-gray-900 dark:text-gray-100">
                  {data[expandedColumn].min !== null &&
                  data[expandedColumn].max !== null
                    ? formatValue(
                        data[expandedColumn].max! - data[expandedColumn].min!
                      )
                    : "-"}
                </p>
              </div>
