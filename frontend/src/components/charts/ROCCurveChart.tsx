...
export function ROCCurveChart({ data, auc, height = 300 }: ROCCurveChartProps) {
  ...
  const aucQuality =
    calculatedAuc !== null ? getAucQuality(calculatedAuc) : null;
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-6 mt-3 text-xs text-muted-foreground">
        ...
        <div className="flex items-center gap-2">
          <div
            className="w-4 h-0.5 bg-muted border-dashed border-t-2 border-muted"
            style={{ height: 0 }}
          />
