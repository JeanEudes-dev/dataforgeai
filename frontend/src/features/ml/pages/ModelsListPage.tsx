        ...
        <div className="relative px-6 py-6 flex flex-wrap items-center justify-between gap-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground max-w-2xl">
              Browse, compare, and deploy the best models discovered by AutoML.
              Each card highlights task, target, top metric, and freshness.
            </p>
          </div>
          <Link to="/datasets">
            <Button>
                  ...
                  >
                    <CardContent className="p-5 space-y-4">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-3">
                          <div
                            className={cn(
                              ...
                              model.is_best
                                ? "border-primary/20 bg-primary/10text-muted-foreground"
                        ...
                        {model.is_best && (
                          <span className="px-2 py-1 text-xs font-semibold rounded-full bg-primary/20text-muted-foreground">
                            Best
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-blue-500/10 text-blue-600 dark:text-blue-400 truncate max-w-[180px]">
                          Target: {model.target_column}
                        </span>
                        {model.dataset_name && (
                          <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-purple-500/10 text-purple-600 dark:text-purple-400 truncate max-w-[180px]">
                            {model.dataset_name}
                          </span>
                        )}
                      </div>
