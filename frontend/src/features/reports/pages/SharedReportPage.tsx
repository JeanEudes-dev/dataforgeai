...
export function SharedReportPage() {
        ...
        <Card className="max-w-md w-full">
          <CardContent className="py-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              This report may have been removed, set to private, or the link is
              incorrect.
            </p>
            <a
              href="/"
  ...
  const enhancedReport: EnhancedReport = {
    ...
    dataset: {
      ...
      file_size_display: "",
      row_count:
        report.content?.dataset?.row_count || report.dataset_row_count || 0,
      column_count:
        report.content?.dataset?.column_count ||
        report.dataset_column_count ||
        0,
      status: "ready",
      created_at: report.created_at,
      updated_at: report.created_at,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <a href="/" className="text-xl font-boldtext-muted-foreground">
                DataForge AI
              </a>
            ...
            <div className="flex items-center gap-2">
              <span className="px-3 py-1 text-xs rounded-full bg-success/10 text-success">
                Public Report
              </span>
            </div>
          </div>
            ...
            <CardContent className="py-4">
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center">
                  <svg
                    className="w-4 h-4text-muted-foreground"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <div>
                  <p className="text-smtext-muted-foreground">
                    This is a publicly shared report. Some data has been limited
                    for privacy. Want to create your own reports?{" "}
                    <a
                      href="/"
      ...
      <footer className="border-t border-border bg-card mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center text-sm text-muted-foreground">
            Report generated by DataForge AI - Automated Data Analytics &
            Machine Learning
          </div>
        </div>
      </footer>
