        ...
        <Card className="border border-border shadow-sm overflow-hidden">
          <CardHeader className="border-b border-border bg-muted/30">
            <CardTitle className="text-base flex items-center gap-2">
              <span className="w-9 h-9 rounded-full bg-primary flex items-center justify-center text-primary-foreground text-sm">
                AI
              </span>
        ...
        <CardContent className="p-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <SummaryTile
              label="Rows analyzed"
              value={
                report.content?.dataset?.row_count?.toLocaleString() || "N/A"
              }
            />
            <SummaryTile
              label="Columns"
              value={report.content?.dataset?.column_count || "N/A"}
            />
            <SummaryTile
              label="Models trained"
              value={report.report_metadata?.models_count || 0}
            />
