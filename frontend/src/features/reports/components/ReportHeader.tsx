...
export function ReportHeader({
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm p-5"
    >
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -right-14 -top-16 w-56 h-56 bg-primary-50 rounded-full blur-3xl" />
        <div className="absolute -left-20 bottom-0 w-48 h-48 bg-gray-100 rounded-full blur-3xl" />
      </div>
