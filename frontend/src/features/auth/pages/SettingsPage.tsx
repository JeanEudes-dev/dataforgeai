...
export function SettingsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <h1 className="text-2xl font-boldtext-muted-foreground">Settings</h1>
        ...
        <CardContent>
          <div className="flex gap-4">
            ...
            >
              ...
              <p className="text-sm font-mediumtext-muted-foreground">Light</p>
            </button>
            <button
            ...
            >
              ...
              <p className="text-sm font-mediumtext-muted-foreground">Dark</p>
            </button>
          </div>
        </CardContent>
      </Card>
